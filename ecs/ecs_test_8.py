...
#        exit(1)
    ...
    ecsDataPath = "data_input/TrainData_2015.6_2015.8.10.txt"
    inputFilePath = "data_input/input_3hosttypes_all_flavors_2week_.txt"
    resultFilePath = "data_input/result.txt"
    answerFilePath = "data_input/TestData_2015.8.18_2015.8.31.txt"
